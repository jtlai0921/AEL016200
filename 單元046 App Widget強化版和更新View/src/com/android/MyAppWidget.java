...
/*		RemoteViews viewAppWidget = new RemoteViews(context.getPackageName(), R.layout.app_widget);
		viewAppWidget.setImageViewResource(R.id.imgViewAppWidget, R.drawable.app_widget_icon);
